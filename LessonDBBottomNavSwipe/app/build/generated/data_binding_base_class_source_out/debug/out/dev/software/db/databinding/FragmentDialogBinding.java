...
public final class FragmentDialogBinding implements ViewBinding {
  ...
  private FragmentDialogBinding(@NonNull LinearLayout rootView,
      @NonNull TextInputLayout authorContainer, @NonNull Button btnUpdate,
  ...
  public static FragmentDialogBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentDialogBinding((LinearLayout) rootView, authorContainer, btnUpdate,
          editAuthor, editGenre, editTitle, genreContainer, titleContainer);
    }
